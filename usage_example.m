...
%% name file
openstreetmap_filename = 'map_phohue.osm';
map_img_filename = 'map_phohue.png'; % image file saved from online, if available
...
only_nodes = 1:10:1686; % not all nodes, to reduce graphics memory & clutter
